...
<head>
    ...
    <title>Shreemit Advance Blood Care Unit | Become A Donor</title>
...
<body>
    ...
    <div class="container">
        ...
        <form name="donar" method="post">
            ...
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div><input type="submit" name="submit" class="btn btn-outline-primary" value="submit" style="cursor:pointer"></div>
                </div>
