...
?>
	...
	<head>
		...
		<title>Shreemit Advance Blood Care Unit | Donor List </title>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">Donor's Info</div>
								<div class="panel-body">
									<?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
									<a href="download-records.php"> <button type="button" class="btn btn-danger">Download Donor List</button></a>
									<br><br>
